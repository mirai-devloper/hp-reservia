...
class HP_Reservia
{
  ...
  public function do_review()
  {
    ...
    $reservia_local_rest = get_rest_url(null, 'api/reservia/reviews');
    $reservia_local_rest_response = wp_remote_get($reservia_local_rest);
    $reservia_local_rest_response_body = json_decode($reservia_local_rest_response['body']);
    $this->total_count = $reservia_local_rest_response_body->total_count;
    ...
    return $this->template('view-zero', $params);
  }
