...
const reserviaReview = new Vue({
  ...
  data() {
    return {
      ...
      star: {
        back: '<svg aria-hidden="true" focusable="false" data-prefix="far" data-icon="star" class="svg-inline--fa fa-star fa-w-18" role="img"><use xlink:href="#svgStarIcon"></use></svg>',
        top: '<svg aria-hidden="true" focusable="false" data-prefix="fas" data-icon="star" class="svg-inline--fa fa-star fa-w-18" role="img"><use xlink:href="#svgStarIcon2"></use></svg>',
      },
      rating: {
        average: 0,
        count: 0
